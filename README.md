...
公告3
平台近期发现大量ts切片视频，占用的流量比较多，触发了cdn防御机制导致业务下线，后续经反馈人工查询日志审核，大量切片视频，人工溯源后，指向了某一个二次元动漫网站，视频内容存在不良广告，违法菠菜广告是违反了我们的tos，大量的切片视频也是违反tos，经评估研究决定，平台即禁止加速 ts m3u8 （2024-7-1）正式执行，在此之间 上述文件将限速 1024/kb 如果有上述资源，请尽快迁移完成，公益是给大家提供基础服务的满足正常使用的，像这种就不是正常使用，是为了盈利目的而目的。，不符合公益性质的。欺负一个公益站能有多少羊毛？好好想一想。哪怕你的视频不在服务器，你只是建一个索引，那也不行，如果你实在有此类需求的话，建议你使用国际站作为视频切片 cdn.jsdelivr.us
