...
当然你“认为”我们镜像jsDelivr是为了窃取jsDelivr官方流量那没有使用的必要的哈 出发点都是错误了 你所有的请求都是毫无保留且不增加任何修改转发jsDelivr 即使修改了首页 增加了广告其实也是对您使用不会产生本质上的影响，那么你可以选择自建或者是使用COS或者是OSS回源jsDelivr来进行加速
...
|e****un.cloud |科学上网                |历史数据|2023-07-26---2024-07-26|中国大陆|
...
|www.b***u.com       |被他人伪造发送该域名Referer  |历史数据|2023-07-26---2024-07-26|中国大陆|


以上 gov和baidu域名会尽快查清楚还对方清白
