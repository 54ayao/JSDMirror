! function(e, t) {
	...
	return function(e) {
				...
				e.exports = function e(t, n, r) {
					...
					4: [
						function(e, t, n) {
							...
							function u(e, t, n) {
								"function" == typeof t && e.then(t), "function" == typeof n && e.
								catch (n)
							}
							...
							var z = {
								...
								dropInstance: function(e, t) {
									...
									WEBSQL: q,
									LOCALSTORAGE: z
								}, X = [W.INDEXEDDB._driver, W.WEBSQL._driver, W.LOCALSTORAGE._driver],
								K = ["dropInstance"],
							...
							var ee = new(function() {
								function e(t) {
									...
									this._defaultConfig = Z({}, Q), this._config = Z({}, this._defaultConfig, t), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).
									catch ((function() {}))
								}
								return e.prototype.config = function(e) {
									...
									var c = null !== this._driverSet ? this._driverSet.
									catch ((function() {
										return a.resolve()
									})) : a.resolve();
											...
											r._driver = e._driver, i(), r._wrapLibraryMethodsWithReady(), r._initDriver = function(e) {
												return function() {
													...
													return function n() {
														for (; t < e.length;) {
															var o = e[t];
															return t++, r._dbInfo = null, r._ready = null, r.getDriver(o).then(s).
															catch (n)
														}
														i();
		...
		function(e, t, n) {
			...
			var r = n(2),
				...
				i = function() {
					...
					function e(e) {
						var t = this;
						this.lifeCycle = new r.a, this.uploadJobQueue = [], this._normalLogPipeline = Object(o.a)([
							function(e) {
								t.send({
									url: t.baseInfo.url,
									data: e,
		...
		function(e, t, n) {
			...
			}, u.spread = n(34), u.isAxiosError = n(35), e.exports = u, e.exports.
			default = u
		},
		function(e, t, n) {
			"use strict";
		...
		function(e, t, n) {
			...
			Object.defineProperty(t, "__esModule", {
				value: !0
			}), t.isNetworkError = a, t.isRetryableError = c, t.isSafeRequestError = f, t.isIdempotentRequestError = l, t.isNetworkOrIdempotentRequestError = d, t.exponentialDelay = h, t.
			default = y;
			var r, o = n(38),
			...
			function a(e) {
				return !e.response && Boolean(e.code) && "ECONNABORTED" !== e.code && (0, i.
					default)(e)
			}
			...
			var u, c = n(1),
				...
				y = function() {
					...
					return e.prototype.reportError = function(e, t) {
						this.requestParams._dc = Math.random(), this.requestParams.error_msg = t, this.requestParams.error_code = e, f.a.get("https://h.trace.qq.com/kv", {
				...
				b = function() {
					...
					return e.prototype.requestConfig = function(e) {
						...
						o(e.baseInfo.appkey + "_Beacon_config_request_time", Date.now().toString()), f.a.post("https://oth.str.beacon.qq.com/trpc.beacon.configserver.BeaconConfigService/QueryConfig", {
							...
							} catch (e) {} else t.processData(null), o(e.baseInfo.appkey + "_Beacon_config", "")
						})).
						catch ((function(e) {}))
				...
				E = function() {
					...
					function t(n) {
						...
						if (r.send = function(e, t, n) {
							...
							o(r.baseInfo.appkey + "_last_report_time", Date.now().toString()), f.a.post(r.remoteConfig.getUploadUrl() + "&appkey=" + r.baseInfo.appkey, e.data).then((function(n) {
								...
								var o = f.a.isCancel(t),
									i = e.data.msgs[0].data.events;
						...
						g()(f.a, {
							...
							retryDelay: g.a.exponentialDelay
						}), g()(f.a, {
							...
							function n() {
								var n = {
									sessionId: e + "_" + t.toString(),
									sessionStart: t
								};
								return setTimeout((function() {
									o(a, JSON.stringify(n)), o(e + "_last_report_time", Date.now().toString());
									var t = e + "_is_new_user",
										r = i(t);
									I.beacon.onDirectUserAction("rqd_applaunched", {
										A21: r ? "N" : "Y"
									}), o(t, JSON.stringify(!1))
								}), 0), n
							}
					...
					return _(t, e), t.prototype.initCommonInfo = function(e) {
							...
							null === (e = t.store.getEvents()) || void 0 === e || e.then((function(e) {
								...
								if (e && e.length > 0) {
									if (e.forEach((function(e) {
										var r = e.params,
											a = r.A99.toString() + r.A100.toString(),
						...
						return function(t) {
							...
							return E(E({}, t), {
								data: i,
								cancelToken: a ? new f.a.CancelToken((function(e) {
						...
						if (a = n ? this.baseInfo.appkey + this.baseInfo.sdkVersion + "direct_log_id" : this.baseInfo.appkey + this.baseInfo.sdkVersion + "normal_log_id", r = (r = Number(i(a))) || 1, t = E(E(E({}, this.additionalParams), t), {
							...
							start: Date.now(),
							count: 1
						}), n && 0 == this.delayTime) this.realSend(u);
						else {
							var c = u.shift();
						...
						for (var t = {}, n = 0, r = Object.keys(e); n < r.length; n++) {
							var o = r[n],
								i = e[o];
							if ("string" == typeof i || "number" == typeof i) t[a(o)] = a(i);
							else {
						...
						if (e) {
							var t = JSON.parse(i(this.baseInfo.appkey + "_sending_event_ids")),
								n = e.params,
								r = n.A99.toString() + n.A100.toString(),
								a = t.indexOf(r); - 1 != a && (t.splice(a, 1), o(this.baseInfo.appkey + "_sending_event_ids", JSON.stringify(t)))
						}
						...
						this.session$.then((function(n) {
							if (0 != e.length) {
								...
								var o = E(E({}, t.getCommonInfo()), {
									opid: t.baseInfo.openid,
									msgs: r
								});
